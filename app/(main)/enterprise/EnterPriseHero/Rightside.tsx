...
on time, that your data will be safely stored, and always available."
        headingClassName=" order-2 text-4xl text-balance text-start"
        paraClassName=" order-3 text-balance text-start"
        btn1ClassName="order-1 my-2 bg-background border text-white hover:text-black"
        btnText={["Enterprise"]}
